  ...
  <div :visible.sync="propVisible">
     ...
     <div class="filter-container">
        ...
        style="width: 100%;">
         ...
         <el-table-column  label="序号"
          ...
          <el-table-column width="80px" align="center" label="进入下阶段必须完成">
            <template slot-scope="scope">
              <span v-if="scope.row.is_must_complete=='是'"><i class="el-icon-star-on" style="color:red"></i></span>
            </template>
          </el-table-column>
          ...
          <el-table-column width="80px" align="center" label="负责人角色">
            ...
            <el-table-column width="300px" align="center" label="操作">
              <template slot-scope="scope">
                  ...
                  <el-button type="primary" size="small" icon="el-icon-delete" @click="handleDelete(scope.row)" >删除</el-button>
              </template>
            </el-table-column>
      ...
      <el-dialog :title="textMap[dialogStatus]" :visible.sync="visible">
            <el-form :rules="rules" ref="NodeTask" :model="temp" label123456781-position="left" label-width="200px" style='width: 600px; margin-left:50px;'>
