<template>
  <div class="app-container">
   ...
   <el-dialog :title="textMap[dialogStatus] + '项目'" :visible.sync="invisible[0]">
    ...
    <el-dialog title="配置联系人信息" :visible.sync="invisible[1]">

        <contact :propContact="temp.contact"></contact>
   ...
   <el-dialog title="配置被测件信息" :visible.sync="invisible[2]">

        <software-info :propSoftwareInfo="temp.softwareInfo" :propRef="dataformMap[2]" :ref="dataformMap[2]"></software-info>
    ...
    <el-dialog title="配置工作流信息" :visible.sync="invisible[3]">
        
        <workflow-item :workflow="temp.workflow" :propRef="dataformMap[3]" :ref="dataformMap[3]" position="left" width="200px" ></workflow-item>
    ...
    <el-dialog title="配置项目组员" :visible.sync="invisible[4]">
  ...
  data() {
    return {
      ...
      temp: {
        ...
        contact:[
          {is_12s:null,organ:'',type:'计划',name:'',tele:'',isEdit:true},
          {is_12s:null,organ:'',type:'质量',name:'',tele:'',isEdit:true},
          {is_12s:null,organ:'',type:'设计',name:'',tele:'',isEdit:true}
        ],
        softwareInfo:{
          name:'',
      ...
      invisible:new Array(false,false,false,false,false),
      ...
      dataformMap:['dataForm0','dataForm1','dataForm2','dataForm3','dataForm4'],
