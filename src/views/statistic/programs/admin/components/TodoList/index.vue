<template>
  <section class="todoapp">
    <!-- header -->
    <header class="header">
      <input class="new-todo" autocomplete="off" placeholder="个人待办事项" @keyup.enter="addTodo">
    </header>
    <!-- main section -->
...
const defalutList = [
  { text: '归零会议', done: false },
  { text: '测试项目1评审', done: false },
  { text: '测试项目2评审', done: false },
  { text: '合同签署', done: true },
  { text: '党建活动', done: true },
  { text: '工会接待', done: true },
  { text: '看望退休老干部', done: true }
]
export default {
  components: { Todo },
  data() {
